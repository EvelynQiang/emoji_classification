...
from BiLSTM.config import DATA_DIR
...
def load_task2(dataset):
    data_file = os.path.join(DATA_DIR, "{}/us_{}.text".format(dataset, dataset))
    label_file = os.path.join(DATA_DIR, "{}/us_{}.labels".format(dataset, dataset))
